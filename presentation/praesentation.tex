...
\begin{frame}
	\frametitle{HTML5}
	\begin{itemize}
		\note{Alternative: SVG; Aufwendige Effekte\\Alternative: Canvas2D; Canvas selber zeichnen, Reihenfolge beachten, clickevents selber umrechen\\(ein kandidat mit svg), (zwei mit canvas)}
		\item Valides HTML5 !
